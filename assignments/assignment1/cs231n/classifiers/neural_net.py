...
class TwoLayerNet(object):
  ...
  def loss(self, X, y=None, reg=0.0):
    ...
    # classifier loss.                                                          #
    #############################################################################
    tiled_max_scores = np.tile(np.amax(scores, axis=1),(self.output_size,1)).T
    scores -= tiled_max_scores
  ...
  def train(self, X, y, X_val, y_val,
    ...
    for it in xrange(num_iters):
      ...
      self.params['b1'] += grads['b1'][0] * -learning_rate
      self.params['W2'] += grads['W2'] * -learning_rate
      self.params['b2'] += grads['b2'][0] * -learning_rate
      #########################################################################
      #                             END OF YOUR CODE                          #
      #########################################################################
